...
fun PracticeScreen(
    ...
    Scaffold(
        ...
        when (val s = state) {
            ...
            is PracticeUiState.Submitting, is PracticeUiState.Grading -> {
                val koreanText = when (s) {
                    is PracticeUiState.Submitting -> s.problem.koreanText
                    is PracticeUiState.Grading -> s.problem.koreanText
                    else -> ""
                }
